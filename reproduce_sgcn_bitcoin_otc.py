...
INPUT_PATH = os.path.join(SGCN_DIR, 'input/bitcoin_otc.csv')
TEMP_EDGE_PATH = os.path.join(SGCN_DIR, 'input/bitcoin_otc_sgcn_edges.csv')
EMBEDDING_PATH = os.path.join(SGCN_DIR, 'output/embedding/bitcoin_otc_sgcn.csv')
WEIGHTS_PATH = os.path.join(SGCN_DIR, 'output/weights/bitcoin_otc_sgcn.csv')
LOG_PATH = os.path.join(SGCN_DIR, 'logs/bitcoin_otc_logs.json')
PLOT_PATH = os.path.join(BASE_DIR, 'sgcn_bitcoin_otc_tsne.png')

def preprocess():
    print("Preprocessing Bitcoin OTC dataset...")
    # Read CSV (Source, Target, Rating, Time)
...
def run_sgcn():
    ...
    with open(os.path.join(SGCN_DIR, 'bitcoin_otc_results.txt'), 'w') as f:
...
def visualize_tsne():
    ...
    plt.title("t-SNE of SGCN Embeddings (Bitcoin OTC)")
